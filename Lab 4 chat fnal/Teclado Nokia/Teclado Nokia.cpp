...
extern "C"{
	...
	{
		compara=1;
		entrada=USART2->SR; //Limpia bandera
		entrada=USART2->DR; //Lee dato recibido
		while(!(USART2->SR&USART_SR_TXE)){asm("nop");} // Espera puerto disponible 
//    USART2->DR=entrada; // Transmite dato
			entrada2=entrada;
